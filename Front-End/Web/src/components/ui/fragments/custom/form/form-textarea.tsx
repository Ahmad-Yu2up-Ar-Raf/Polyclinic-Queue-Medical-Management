...
export function FormTextArea(props: FormTextAreaProps) {
  ...
  const invalidClass =
    ...
    "border-b-destructive bg-destructive/5 focus-visible:text-destructive focus-visible:placeholder:text-destructive"
  ...
  return (
    <FormBase {...props}>
      <div
        className={cn(
          "relative flex w-full overflow-hidden border-b transition-all duration-300 ease-in-out",
      ...
      >
        ...
        <Textarea
          ...
          className={cn(
            "w-full resize-none border-0 bg-transparent py-4 pr-4 text-sm shadow-none transition-colors focus-visible:ring-0",
