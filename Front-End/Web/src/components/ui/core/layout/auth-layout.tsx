...
import AppLogo from "../../fragments/custom/app-logo"
import MediaItem from "../../fragments/custom/media-item"
  ...
  return (
    <div className="grid min-h-dvh lg:flex">
        ...
        <div className={cn("relative flex h-full flex-col gap-4")}>
          ...
          <Card className="relative m-auto flex h-fit w-full max-w-sm flex-col justify-center gap-8 bg-transparent p-0 ring-0">
            <CardContent className="size-full border-0 p-0">
              ...
              <div className="relative my-6 flex flex-col gap-4 md:my-9 md:px-7">
                {children}
              </div>
      ...
      <div className="relative hidden content-center justify-end bg-background lg:block dark:border-l">
        <MediaItem
          webViewLink={"/assets/video/consultant.mp4"}
          mediaType="video"
