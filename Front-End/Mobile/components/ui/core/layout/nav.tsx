      ...
      <View
        ...
        {title || scrollAnimatedPosition ? (
          <Animated.View style={animatedTitleStyle}>
            <Text
              variant="h4"
              className="font-figtree_medium line-clamp-1 text-center text-xl tracking-tighter"
              numberOfLines={1}>
              {title}
            </Text>
          </Animated.View>
          ...
          <View className="items-center justify-center gap-7 text-center">
            {/* <Text
              variant={'small'}
              className="font-figtree_medium text-xs tracking-tighter text-muted-foreground/60">
              Location
            </Text> */}
            <View className="w-fit flex-row items-center gap-1.5">
              ...
              <Text
                variant="h4"
                className="font-figtree_semibold text-center text-base tracking-tighter">
                LiveUp
              </Text>
            </View>
          </View>
