      ...
      <Wrapper
        ...
        <View className="w-full gap-6">
          ...
          <View className="w-full gap-2">
            <Text
              variant={'h3'}
              className="font-figtree_semibold text-center text-2xl tracking-tighter">
              {user?.name}
            </Text>
            <Text
              variant={'small'}
              className="font-figtree_medium text-center text-sm tracking-tighter text-muted-foreground/60">
              {user?.email}
            </Text>
          </View>
        </View>
        <MenuCard MenuList={menuDetails2} onSignOut={handleLogout} />
      </Wrapper>
    </>
  );
}
