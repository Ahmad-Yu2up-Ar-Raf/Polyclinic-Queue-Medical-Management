...
export const pendaftaranLamaSchema = z.object({
  ...baseAntreanFields,
  pasien_id: z.coerce.number({ required_error: 'Pasien wajib dipilih' }),
});

export const selectPasien = pendaftaranLamaSchema.pick({
  pasien_id: true,
});

export type SelectPasien = z.infer<typeof selectPasien>;
...
export type PendaftaranLama = z.infer<typeof pendaftaranLamaSchema>;
