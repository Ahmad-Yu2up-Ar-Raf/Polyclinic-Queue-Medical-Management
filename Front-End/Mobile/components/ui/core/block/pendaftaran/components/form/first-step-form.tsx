...
import { useFirstStepForm } from '@/components/ui/core/block/pendaftaran/hooks/use-pendaftaran';
import { firstStepSchema } from '@/components/ui/core/block/pendaftaran/schema/pendaftaran-validation';

import { JenisKelaminRadioGroup } from '@/components/ui/core/block/pendaftaran/components/form/radio/jeni-kelamin-radio';
import {
  Call02FreeIcons,
...
export default function FirstStepForm({
  onSubmitRef,
  onLoadingChange,
  onDirtyChange, // 🔥 2. Destructure props-nya
  ...
  return (
    <form.Subscribe
      ...
      {({ isSubmitting, isDirty }) => {
        ...
        }, [isSubmitting, onLoadingChange]); // Pastikan taruh di dependency array
        React.useEffect(() => {
