...
import { ChevronRight, LogOut } from '@hugeicons/core-free-icons';
      ...
      <CardContent className="w-full overflow-hidden p-0">
            ...
            <React.Fragment key={`menu-item-${i}`}>
              <Button
                ...
                <View className="flex-row items-center gap-5">
                  ...
                  <Text variant="h3" className="font-figtree_medium text-base">
                    {detail.Label}
                  </Text>
                </View>
        ...
        <Button
          ...
          <View className="flex-row items-center gap-5">
            ...
            <Text variant="h3" className="font-figtree_medium text-base text-destructive">
              Log Out
            </Text>
          </View>
        </Button>
